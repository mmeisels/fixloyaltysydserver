...
function addItem(req, res, next) {
    ...
    getPointBalance(userId)
        .then(function(result) {
            ...
            db.query('INSERT INTO salesforce.interaction__c (Contact_LoyaltyId__c, campaign__c, product__c, type__c, points__c, name__c, picture__c) VALUES ($1, $2, $3, $4, $5, $6, $7)',
...
function getPointBalance(userId) {
    return db.query('select sum(points__c) as points from salesforce.interaction__c where Contact_LoyaltyId__c=$1', [userId], true);
}
